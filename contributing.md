# Contributing to nodebots-server

First and foremost, thank you! We appreciate that you want to contribute to nodebots-server, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for nodebots-server**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for nodebots-server:

- star the [project](https://github.com/doowb/nodebots-server)
- tweet your support for nodebots-server
...
- **version**: please note the version of nodebots-server are you using
...
[so]: http://stackoverflow.com/questions/tagged/nodebots-server